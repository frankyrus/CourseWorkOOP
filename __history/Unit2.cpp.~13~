...
void __fastcall TdogeAdd::Button1Click(TObject *Sender) {
	if (ComboBox1->ItemIndex == 0) {
		DogForm->dogsTree->Select(DogForm->dogsTree->Items->AddChild(DogForm->dogsTree->Items->Item[0],
			Edit1->Text));
	}
	...
	DogForm->dogsImages->Add(Image1->Picture->Bitmap,NULL);
	Edit1->Text="";
	Edit2->Text="";
	Edit3->Text="";
	Edit4->Text="";
...
void __fastcall TdogeAdd::Button2Click(TObject *Sender) {
	...
	DogForm->OpenDialog1->Filter = "Image files (*.bmp)|*.BMP";
